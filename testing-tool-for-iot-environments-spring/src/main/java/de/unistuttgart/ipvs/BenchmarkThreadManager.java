...
import SimulationToolForTheInternetOfThings.SensorSimulatorThread;
import SimulationToolForTheInternetOfThings.SensorThreadClock;
...
public class BenchmarkThreadManager extends Thread {
    ...
    public void startThreads() {
        for (int i = 0; i < numberOfThreads; i++) {
            ...
            ReceiverSenderThread newThread = new ReceiverSenderThread(newPortNumber);
